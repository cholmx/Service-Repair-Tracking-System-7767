...
const { FiUser, FiPhone, FiMail, FiPackage, FiFileText, FiCalendar, FiSave, FiPlus, FiMinus, FiBuilding } = FiIcons;
  ...
  const validateForm = () => {
    ...
    formData.items.forEach((item, index) => {
      if (!item.itemType.trim()) {
        newErrors[`items.${index}.itemType`] = 'Service Order type is required';
      }
        ...
        <form onSubmit={handleSubmit} className="bg-white rounded-xl shadow-lg p-8">
          ...
          <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
              ...
              <div>
                <label className="flex items-center text-sm font-medium text-neutral-700 mb-2">
                  <SafeIcon icon={FiBuilding} className="mr-2 text-primary-500" />
                  Company
                </label>
                <input
                  type="text"
          ...
          <div className="mb-8">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-semibold text-neutral-900 border-b border-neutral-200 pb-2">Service Orders Information</h2>
              <button
                type="button"
                onClick={addItem}
              ...
              {formData.items.map((item, index) => (
                ...
                >
                  <div className="flex items-center justify-between mb-4">
                    <h3 className="text-lg font-medium text-neutral-900">Service Order {index + 1}</h3>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                    <div>
                      ...
                      <input
                        ...
                        placeholder="Enter Service Order type"
                      />
          ...
          <div className="flex justify-end">
            ...
            >
              ...
              <span>Register Service Orders</span>
            </motion.button>
          </div>
        </form>
      </motion.div>
